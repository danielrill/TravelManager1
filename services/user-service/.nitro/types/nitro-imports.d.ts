declare global {
  ...
  const checkSignupCode: typeof import('../../utils/tenants').checkSignupCode
  ...
  const genSignupCode: typeof import('../../utils/tenants').genSignupCode
  ...
  const initUserDb: typeof import('../../utils/schema').initUserDb
  ...
  const listTenants: typeof import('../../utils/tenants').listTenants
  const markProvisioned: typeof import('../../utils/tenants').markProvisioned
